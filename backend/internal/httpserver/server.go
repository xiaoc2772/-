...
func New(deps Dependencies) http.Handler {
	...
	router.Route("/api", func(api chi.Router) {
		...
		api.Route("/games/piano-tiles", func(pianoRouter chi.Router) {
			...
			pianoRouter.Get("/personal-bests", pianoTilesHandlers.personalBests)
			pianoRouter.Post("/start", pianoTilesHandlers.start)
			pianoRouter.Post("/checkpoint", pianoTilesHandlers.checkpoint)
			pianoRouter.Post("/submit", pianoTilesHandlers.submit)
			pianoRouter.Post("/cancel", pianoTilesHandlers.cancel)
			pianoRouter.HandleFunc("/*", notMigratedHandler("piano_tiles"))
			pianoRouter.HandleFunc("/", notMigratedHandler("piano_tiles"))
		})
